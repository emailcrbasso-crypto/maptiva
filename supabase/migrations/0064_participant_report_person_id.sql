-- =====================================================================
-- 0064_participant_report_person_id.sql
--
-- get_participant_report v2 — adiciona person.id ao retorno (necessário
-- para o botão "Criar PDI a partir deste relatório" saber a quem o PDI
-- pertence). Sem outras mudanças de comportamento.
-- =====================================================================
